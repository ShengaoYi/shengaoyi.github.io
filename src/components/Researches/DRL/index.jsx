...
import wildfire from '../../Projects/images/Wildfire.gif';
import {Breadcrumb, Layout, Row, Tooltip} from "antd";
import {Link} from "react-router-dom";
import {Image} from 'antd';
import fire1 from "../../Projects/images/Fire1.png";
import fire2 from "../../Projects/images/Fire2.png";
...
const DRL = () => (
    <div className="container-centered">
        <Content className="site-layout-background content-width">
            ...
            <div className="title">
                <h1>Deep online recommendations for connected E-taxis by coupling trajectory mining and reinforcement learning</h1>
